...
<head>
  ...
  <style>
    ...
    :root {
      --bg-body: #151515; /* Changed from #000000 */
      --bg-card: #1c1c1e;
      --bg-sidebar: #121212;
      --text-main: #f5f5f7;
      --text-muted: #86868b;
    ...
    .sidebar {
      width: 260px;
      background: #151515; /* Unified solid background */
    ...
    .sidebar .nav-link.active {
      background: var(--accent-blue); /* Keep the Blue Button style */
      color: #fff;
    ...
    .main-content {
      flex: 1;
      padding: 2rem;
      background: var(--bg-body); /* Uses #151515 */
      overflow-y: auto;
    }
...
<body>
  ...
  <div class="topbar">
          ...
          <div>
                    ...
                    <a class="navbar-brand text-light ml-2 d-none d-md-inline d-flex align-items-center" href="{{ url('/') }}">
                        <svg class="bi bi-apple mr-2" width="20" height="20" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
